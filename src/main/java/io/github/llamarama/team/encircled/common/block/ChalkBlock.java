...
import io.github.llamarama.team.encircled.api.block.properties.ChalkType;
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (holdsItem && state.getBlock() == ModBlocks.CHALK) {
            ...
            if (chunk instanceof ChaosProvider)
                player.sendMessage(new LiteralText(Integer.toString(((ChaosProvider) chunk).getChaosValue())), false);
        }
