package io.github.llamarama.team.encircled.client.render.blockentity;

import io.github.llamarama.team.encircled.api.client.DefaultBERenderer;
import io.github.llamarama.team.encircled.client.EncircledClient;
import io.github.llamarama.team.encircled.common.block_entity.OfferingPlateBlockEntity;
...
//        if (ClientConfig.ENABLE_ITEM_RENDERING.get()) {
        ...
        if (!stack.isEmpty()) {
            ...
            if (stack.getItem() == Items.DRAGON_EGG /*&& ClientConfig.SPECIAL_BLOCK_RENDERING.get()*/) {
                ...
                EncircledClient.getGame().getBlockRenderManager().renderBlockAsEntity(
                        Blocks.DRAGON_EGG.getDefaultState(), matrices, vertexConsumers, light, overlay);
            } else {
                matrices.scale(1.5f, 1.5f, 1.5f);
                Item item = stack.getItem();
                EncircledClient.getGame().getItemRenderer().renderItem(item.getDefaultStack(),
